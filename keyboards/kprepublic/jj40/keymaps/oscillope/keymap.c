...
[_QWERTY] = LAYOUT_planck_1x2uR( \
  ...
  KC_LCTL, KC_LGUI, KC_LALT, MO(_LOWER), KC_LSFT, MO(_RAISE), NAV_TAP,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
),
...
[_LOWER] = LAYOUT_planck_1x2uR( \
  ...
  KC_INS,  _______, KC_PSCR, CC_PRN,  CC_BRC,  CC_CBR,  KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, _______,\
...
[_NAV] = LAYOUT_planck_1x2uR( \
  ...
  _______, _______, KC_MPRV, KC_MSTP, KC_MPLY, KC_MNXT, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,\
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,\
